...
class View(object):
    ...
    def __init__(self, track: tracking.Track, attached_panel: 'Panel', renderer_name: Optional[str] = None, show: bool = True,
                 color: Tuple[int, int, int, int] = (255, 255, 255, 255), **parameters):
        self.track = track
        self.show = show
...
class Panel(object):
    ...
    def new_view(self, track: tracking.Track, renderer_name: Optional[str] = None, show: bool = True,
                 color: Tuple[int, int, int, int] = (255, 255, 255, 255), pos: Optional[int] = None, **parameters) -> View:
        if not pos:
            pos = len(self.views)
    ...
    #def update_view_from_track(self, track: tracking.Track, pos: Optional[int] = None):
    #    if not pos:
    #        pos = 0
    #    self.views[pos].track = track
    #    self.selected_view = self.views[pos]
...
class Model(object):
    ...
    def new_panel(self, pos: Optional[int] = None) -> Panel:
        ...
        if len(self.panels) == 1:
            self.selected_panel = self.panels[pos-2] # 2 to skip 0 (outliers) and 1 (buttons)
        return self.panels[pos-2]
