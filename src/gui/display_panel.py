...
class Frame(QtWidgets.QFrame):
    ...
    def minimumSizeHint(self) -> QtCore.QSize:
        return QtCore.QSize(200, 100)  # TODO: read from config file?

    def sizeHint(self) -> QtCore.QSize:
        return QtCore.QSize(300, 125)  # TODO: read from config file? (One or the other)
...
class DisplayPanel(QtWidgets.QWidget):
    ...
    def __init__(self, frame: Frame):
        ...
        layout.addWidget(self.table_splitter) # Make frame occupy all the space
    ...
    #def update_view_from_display_panel(self, new_track): 
    #   updated_view = self.panel.update_view_from_track(new_track, 0)
    #    self.view_table.updateView(updated_view)
    ...
    def addRRDerivative(self, parent_view, panel_index, new_rr):
        self.selectView(parent_view)
        self.main_window.parent()
        
        self.main_window.application.add_view_from_track(parent_view.track.derive_RR(new_rr), panel_index)
