...
class ViewTable(QtWidgets.QTableWidget):
    ...
    #def updateView(self, view_object: View, setColor=True):
    #    """
    #    Add the view_object to the existing panel
    #    and display information in the table
    #    """
    #    # get previous views in panel
    #    previous_views = self.panel.views
    #    for previous_view in previous_views:
    #        self.delView(previous_view)

    #    # delete previous views in plot area
    #    self.display_panel.plot_area.axes = {}
        
    #    self.display_panel.plot_area.vbs = {}

    #    # add the new view
    #    self.addView(view_object)
        
    #    print("track in new view")
    #    print(self.panel.views[0].track.value)
